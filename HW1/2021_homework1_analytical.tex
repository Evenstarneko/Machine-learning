...
=& \frac{P(no \ cough | fever) \cdot P(fever | pneumonia) \cdot P(pneumonia)}{[1-P(cough | fever)] \cdot P(fever)} \\
=& \frac{[1-P(cough | fever)] \cdot P(fever | pneumonia) \cdot P(pneumonia)}{[1-P(cough | fever)] \cdot P(fever)} \\
=& 0.08 
\end{align}
\end{answertext} 
