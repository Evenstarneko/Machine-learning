...
The size of joint probability table is $2^{k}$.
...
From $(X_{1} {\perp\!\!\!\perp} X_{3}, \ldots, X_{k} \mid X_{2})$ we have $(X_{1} {\perp\!\!\!\perp} X_{4}, X_{5}, \ldots, X_{k} \mid X_{2}, X_{3})$ \\
And we know $(X_{2} {\perp\!\!\!\perp} X_{4}, X_{5}, \ldots, X_{k} \mid X_{1}, X_{3})$ \\
Combining the two relations, we have $(X_{1}, X_{2} {\perp\!\!\!\perp} X_{4}, X_{5}, \ldots, X_{k} \mid X_{3})$ \\
From there, we know $(X_{1}, X_{2} {\perp\!\!\!\perp} X_{5}, \ldots, X_{k} \mid X_{3}, X_{4})$ \\
Combing with the assumption that $(X_{3} {\perp\!\!\!\perp} X_{1}, X_{5}, X_6, \ldots, X_{k} \mid X_{2}, X_{4})$ \\
We have $(X_{1}, X_{2}, X_{3} {\perp\!\!\!\perp} X_{5}, \ldots, X_{k} \mid X_{4})$ \\
And so on, we can finally have $(X_{1}, X_{2}, \ldots, X_{k-2} {\perp\!\!\!\perp} X_{k} \mid X_{k-1})$ \\
\\
\begin{align}
p(X_{1}, X{2}, \ldots, X{k}) &= p(X_{1}, X_{3}, X_{4}, \dots, X_{k} \mid X_{2}) \notag\\
...
\end{align}
As such, it only need a polynomial number of parameters ($2k$) to compute. \\
